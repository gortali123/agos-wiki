...
Traccia unica delle incongruenze rilevate tra le tre fonti di verità del progetto: **codice** (`raw/dwh-code/`), **skill** (`.claude/skills/develop-l2`, `develop-l3`, `dm-reader`) e **documentazione** (docx/xlsx ingeriti in [[caricamento-layer-l0-l1]], [[caricamento-layer-l2]], [[guida-sviluppo]], [[layer-l2-xlsx-reference]]). Le voci non vengono cancellate quando risolte: si marcano "Risolta" con la data, così la pagina resta uno storico di cosa è stato verificato e quando.

## Indice

| # | Titolo | Codice | Skill | Doc | Stato |
|---|---|---|---|---|---|
| 1 | query_tag L2: obbligatorio, assente/errato nel codice | ⚠️ incompleto/errato | — | ✅ prescrive obbligo | Aperta (2026-07-14) |
| 2 | Cancellazioni L2: due meccanismi non equivalenti | ⚠️ incompleto in più aree | — | ✅ prescrive 2 step sempre | Aperta (2026-07-14) |
| 3 | Flag: xlsx dice S/N, codice/docx usano Y/N | ✅ Y/N pervasivo | — | ⚠️ xlsx diverge dal docx | Aperta (2026-07-14) |
| 4 | Prefissi campo: liste diverse docx/xlsx | ✅ nessun prefisso PR_ osservato | — | ⚠️ docx/xlsx non riconciliate | Aperta (2026-07-14) |
| 5 | Subject area: due tassonomie di sigle | ✅ solo nome esteso osservato | — | ⚠️ xlsx sigle mai viste nel codice | Aperta (2026-07-14) |
| 6 | dbt_artifacts.upload_results documentato, non presente | ✅ usa log_run_results/TECH.LOG_DBT | — | ⚠️ descrive dbt_artifacts | Aperta (2026-07-14) |
| 7 | Nomi test generici: doc dice `_table`, codice no | ✅ nomi senza `_table` | — | ⚠️ doc con suffisso `_table` | Aperta (2026-07-14) |
| 8 | Macro documentate ma non trovate/nome diverso | ✅ nomi reali diversi | — | ⚠️ nomi non corrispondenti | Aperta (2026-07-14) |
...
- **Dettagli**: [[query-tag-monitoring]], [[storicizzazione-l2-s1-s4]], [[l2-carte]], [[l2-provvigioni-rappel]], [[l2-rischi-adempimenti]].
