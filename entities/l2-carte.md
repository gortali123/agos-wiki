...
**Inconsistenza sistematica verificata (2026-07-14)**: tutti e 6 i modelli dell'area hanno `query_tag` valorizzato ma con `"schema": "L2_PRODOTTO"` invece di `L2_CARTE` — un mismatch a livello di intera cartella, non un typo isolato. Vedi [[inconsistenze-doc-vs-codice]].
