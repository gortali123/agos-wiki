...
accettazione_input_agg as (
    ...
    select
        ...
        max(case when b.cd_ruolo = 'R' then b.cd_ctcpos_score_completo_fascia end) as TP_CTCPOS_SCORE_COMPL_FASC_CLI,
        max(case when b.cd_ruolo = 'G' then b.cd_ctcpos_score_completo_fascia end) as TP_CTCPOS_SCORE_COMPL_FASC_COO,
        ...
        max(case when b.cd_ruolo = 'G' then b.PC_DBR_PERC_INDEBIT_PRATICA end) as PC_DBR_PERC_INDEBIT_PRATICA,
...
select
    ...
    aia.TP_CTCPOS_SCORE_COMPL_FASC_CLI,
    aia.TP_CTCPOS_SCORE_COMPL_FASC_COO,
    ...
    aia.PC_DBR_PERC_INDEBIT_PRATICA,
    aia.cd_processcode,
