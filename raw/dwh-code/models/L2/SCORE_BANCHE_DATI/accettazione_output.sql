...
raw AS (
    ...
    SELECT
        ...
        {{ get_xml_path('n_req_var', 'SCIPAFI_TIPO', 'VARCHAR') }} AS TP_SCIPAFI,
...
conv AS (
    ...
    SELECT
        ...
        TRY_CAST(PC_DBR_PERC_INDEBITAMENTO_PRATICA_RAW AS NUMBER(16,0)) AS PC_DBR_PERC_INDEBIT_PRATICA,
        ...
        DS_MESSAGGIO,
        TRY_CAST(NM_ETA_CLIENTE_TERMINE_FINANZIAMENTO_RAW AS NUMBER(16,0)) AS NM_ETA_CLI_TERM_FINANZIAM,
        ...
        TRY_CAST(EU_FIDO_MASSIMO_SCORING_RAW AS NUMBER(16,2)) AS EU_FIDO_MASSIMO_SCORING,
        CD_VALUTAZIONE_PRT,
