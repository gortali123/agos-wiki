...
app_raw AS (
    ...
    SELECT
        ...
        {{ get_xml_path('n_app_var', 'LAST_EURISC_INC_CLI_CODICE_PRATICA', 'VARCHAR') }}     AS CD_LAST_EURISC_INC_CLI_COD_PRA,
        ...
        {{ get_xml_path('n_app_var', 'CTCPOS_SCORE_COMPORTAMENTALE_DT', 'VARCHAR') }}        AS DT_CTCPOS_SCORE_COMPORT_DT,
        {{ get_xml_path('n_app_var', 'CTCPOS_SCORE_COMPORTAMENTALE_FASCIA', 'VARCHAR') }}    AS CD_CTCPOS_SCORE_COMPORT_FASCIA,
...
SELECT
    ...
    TRY_TO_DATE(a.DT_LAST_EURISC_INC_CLI_DATA_CARICAMENTO_RAW)   AS DT_LAST_EURISC_INC_CLI_DT_CAR,
    TRY_TO_DATE(a.DT_LAST_EURISC_INC_CLI_DATA_ELABORAZIONE_RAW)  AS DT_LAST_EURISC_INC_CLI_DT_ELAB,
    a.CD_LAST_EURISC_INC_CLI_COD_PRA                 AS CD_LAST_EURISC_INC_CLI_COD_PRA,
    ...
    a.DT_CTCPOS_SCORE_COMPORT_DT                    AS DT_CTCPOS_SCORE_COMPORT_DT,
    a.CD_CTCPOS_SCORE_COMPORT_FASCIA               AS CD_CTCPOS_SCORE_COMPORT_FASCIA,
