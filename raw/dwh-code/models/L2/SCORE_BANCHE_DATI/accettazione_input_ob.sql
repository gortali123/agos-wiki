...
conv AS (
    ...
    SELECT
        ...
        TRY_CAST(EU_OB_INVESTIMENTI_FINANZIARI_ENTRATE_RAW AS NUMBER(16,2)) AS EU_OB_INVEST_FINANZ_ENTRATE,
        TRY_CAST(EU_OB_INVESTIMENTI_FINANZIARI_USCITE_RAW AS NUMBER(16,2)) AS EU_OB_INVEST_FINANZ_USCITE,
...
SELECT
    ...
    EU_OB_FINANZIAMENTI,
    EU_OB_INVEST_FINANZ_ENTRATE,
    EU_OB_INVEST_FINANZ_USCITE,
    FL_OB_ALERT_SPESE_MORE_RITARDI,
