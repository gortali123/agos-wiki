...
SELECT
    ...
    {{ ole_to_date('cas.CAS_DATA_SCADENZA') }} AS DT_SCADENZA,
    {{ ole_to_date('cas.CAS_DATA_EMISSIONE') }} AS DT_PRESENTAZIONE,
    {{ ole_to_date('cas.CAS_DATA_REG_INSOL') }} AS DT_REG_INSOLUTO,
    cas.CAS_NUMERO_RATA AS NM_RATA,
    {{ ole_to_date('cas.CAS_DATA_SCADENZA_ORIG') }} AS DT_SCADENZA_ORIG,
    ...
    cas.CAS_TIPO_EFFETTO AS TP_EFFETTO,
