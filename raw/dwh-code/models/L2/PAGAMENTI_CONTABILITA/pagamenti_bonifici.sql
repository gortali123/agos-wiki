...
SELECT
    ...
    {{ custom_to_date('b.BOW_DATA_CREAZIONE') }} AS DT_CREAZIONE,
    {{ custom_to_date('b.BOW_DATA_SCADENZA') }} AS DT_SCADENZA,
    {{ custom_to_date('b.BOW_DATA_PRESENTAZIONE') }} AS DT_PRESENTAZIONE,
    ...
    b.BOW_PLICO AS BOW_PLICO,
    b.BOW_MIR AS BOW_MIR,
    ...
    b.BOW_PROGR_PRAT AS BOW_PROGR_PRAT,
    b.BOW_ESITO_6 AS BOW_ESITO_6,
    b.BOW_ESITO_7 AS BOW_ESITO_7,
    b.BOW_ESITO_9 AS BOW_ESITO_9,
    b.BOW_GROUP_STATUS AS BOW_GROUP_STATUS,
    b.BOW_DATA_DA AS BOW_DATA_DA,
    b.BOW_DATA_AL AS BOW_DATA_AL
FROM {{ ref('ccbonwk') }} b
