...
SELECT
    ...
    -- TODO quando ci sarà il campo OXINREPT_EV_INC_ST { custom_to_date('st.OXINREPT_DATA_REGISTRAZIONE') } AS DT_REG_STORNO,
    ...
    CAST(NULL AS DATE) AS DT_REG_STORNO,
...
-- -- storno di t (t.EV_INC_ST -> st.EVENTO): fornisce la data DT_REG_STORNO
-- LEFT JOIN {{ ref('oxinfrept') }} st
