...
FROM AGOS_DEV_16000.L1_E_DIL.PCT_ACCESSO_UTENTE_TEST AS A

-- FROM { re('pct_accesso_utente_test') }} A 

-- WARN: nessun campo tecnico di storicizzazione
-- (LASTMODIFIEDDATA/DT_OSSERVAZIONE) nel data model;
-- trattata come S4 (insert_overwrite, nessun filtro incrementale),
-- da confermare col team

-- WARN: LENGTH dichiarato 'TBD' per tutti i campi nel data model;
-- data type nello yml da fallback naming convention